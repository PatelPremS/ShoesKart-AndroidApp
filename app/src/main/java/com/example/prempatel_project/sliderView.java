...
public class sliderView extends PagerAdapter {
    ...
    private Integer [] images = {R.drawable.slider_img1,R.drawable.slider_img2,R.drawable.slider_img3};
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        ...
        View view = layoutInflater.inflate(R.layout.activity_slider_view, null);
